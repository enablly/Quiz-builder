#!/bin/bash
sed -i -e '/const prompt = "You are a Senior Workplace Strategy Architect.\\n" +/,/"Return ONLY valid HTML. Do not wrap in markdown or backticks.";/c\
